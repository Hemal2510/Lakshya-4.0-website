export default function Footer() {
    return (
        <footer className="bg-blue-950 text-white pt-10 pb-6 px-6">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                {/* About Section */}
                <div>
                    <div className="font-bold mb-2 text-lg">Lakshya 2025</div>
                    <div className="mb-3">
                    ...
                    <div className="font-bold mb-1">Let's innovate, let's transform, let's break the monotony.</div>
                ...
                {/* Contact for events */}
                <div>
                    <div className="font-bold mb-2">Contact For Events</div>
                    {/* Placeholder contacts */}
                    <div className="font-semibold">Name 1</div>
                    <div className="mb-1">+91 XXXXXXXX</div>
                ...
                <div>
                    ...
                    <div className="mb-1">Contact 1: +91 XXXXXXXXXX</div>
                    <div className="mb-1">Contact 2: +91 XXXXXXXXXX</div>
                    <div className="mb-1">Contact 3: +91 XXXXXXXXXX</div>
